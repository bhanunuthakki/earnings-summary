...
# specifically identified legacy row; commitment receipts validate their sealed historical transcript
# coordinate; section-item, longitudinal, and tone
...
AUDITED_RAW_RELATION_READS = {
    ...
    "src/pipeline/commitment_scan_receipts.py": 1,
