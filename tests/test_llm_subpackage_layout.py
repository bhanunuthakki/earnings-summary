...
def test_news_pins_do_not_disturb_existing_purposes() -> None:
    ...
    # Pre-existing Opus pins — unchanged. (company_description moved to
    # Sonnet via the model-eval downgrade loop, #444 — the assertion tracks
    # the registry's CURRENT intent, not its history.)
