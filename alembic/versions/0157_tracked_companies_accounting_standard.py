...
Same ADD-COLUMN-with-inline-CHECK-via-raw-SQL mechanics as 0156 (see that
...
Revision ID: 0157_tracked_companies_accounting_standard
Revises: 0156_tracked_companies_business_model_class
...
revision: str = "0157_tracked_companies_accounting_standard"
down_revision: str | Sequence[str] | None = "0156_tracked_companies_business_model_class"
...
def downgrade() -> None:
    ...
    if _has_column(insp, _TABLE, _COLUMN):
        # Raw SQL, NOT op.batch_alter_table -- see 0156's downgrade comment
