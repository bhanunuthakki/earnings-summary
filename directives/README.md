...
- `cheapest_model_routing.md` — SHIPPED cost-aware routing (Claude + Gemini, eval-gated,
  cheapest-at-parity); the most-active recent theme (#533/#536/#537/#538). Mechanics overlap
  with `gemini_backend.md` and `model_eval_loop.md`.
- `residual_backlog_2026_06.md` — bounded residual chips after the two big programs;
  reconciled to NOT overlap Close-the-Loops.
...
- Layer-1 baselines (immutable without owner sign-off): `data_pipeline_dag.md`,
  `data_provenance.md`, `per_ticker_enhancements.md`.
- UI / output contracts: `design_language.md` (canonical v3), `report_comments_and_chat.md`.
- LLM mechanics & governance: `llm_calls.md`, `llm_evals_plan.md`, `model_eval_loop.md`,
  `gemini_backend.md` (backend mechanics), `llm_injection_threat_model.md`,
