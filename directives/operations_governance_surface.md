...
- **Idempotency key:** canonical owner identity plus registry/snapshot version. Repeating the projection over unchanged owners and evidence must yield the same disposition and rendered meaning.
