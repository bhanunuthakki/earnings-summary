...
- **Always included** (61 of the 67 `per_ticker_jobs` endpoints): everything EDGAR structurally cannot provide — segmentation, growth series, TTM statements, ratios/key-metrics, analyst estimates, DCF, 10-K/10-Q JSON, price history, peers, profile, etc. This is the actual point of the ~6-monthly window; EDGAR never touches these.
