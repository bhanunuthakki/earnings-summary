...
def _canary_shell_payloads() -> dict[str, object]:
    ...
    return {
        ...
        "evaluation": {
            "schema_version": "evaluation_surface.v2",
            "generated_at": "2026-01-01T00:00:00Z",
            "count": 2,
            "items": [
                {
                    ...
                    "profile": {
                        "labels": [
                            {
                                "label": "long_term_compounder",
                                "display_label": "Long-term compounder",
                                "state": "system_suggested",
                                "suggested": True,
                                "suggestion_fingerprint": "a" * 64,
                                "source_kind": "qualitative_synthesis",
                            },
                            {
                                "label": "garp",
                                "display_label": "GARP",
                                "state": "system_suggested",
                                "suggested": True,
                                "suggestion_fingerprint": "b" * 64,
                                "source_kind": "dcf_rule",
                            },
                        ],
                        "summary": "Durable growth with a valuation-supported entry profile.",
                        "state": "system_suggested",
                        "moat": {
                            "level": "core_business",
                            "evidence_coverage": "sufficient",
                            "rationale": "Embedded workflows and scale defend the core business.",
                            "supporting_evidence": [],
                            "counter_evidence": [],
                        },
                        "source_artifact_id": 9,
                        "refresh_fingerprint": "c" * 64,
                    },
                    "portfolio_indicators": [
                        {
                            "key": "divers",
                            "label": "Diversification",
                            "detail": "Moderate correlation to the held book",
                            "effect": "positive",
                            "missing": False,
                        },
                        {
                            "key": "sector",
                            "label": "Sector fit",
                            "detail": "Adds to a light consumer sleeve",
                            "effect": "positive",
                            "missing": False,
                        },
                    ],
                    "portfolio_role_labels": ["Diversifier", "Adds sector breadth"],
                ...
                },
                {
                    ...
                    "profile": {
                        "labels": [
                            {
                                "label": "thematic_exposure",
                                "display_label": "Thematic exposure",
                                "state": "system_suggested",
                                "suggested": True,
                                "suggestion_fingerprint": "d" * 64,
                                "source_kind": "etf_rule",
                                "evidence_summary": "Energy is the current structured sector exposure.",
                            },
                            {
                                "label": "diversifier",
                                "display_label": "Diversifier",
                                "state": "system_suggested",
                                "suggested": True,
                                "suggestion_fingerprint": "e" * 64,
                                "source_kind": "etf_rule",
                                "evidence_summary": "The modeled book fit improves diversification.",
                            },
                        ],
                        "summary": "Sector and book-fit labels derived from current structured ETF evidence.",
                        "state": "system_suggested",
                        "evidence_coverage": "partial",
                        "evidence_gaps": ["Factor-loading evidence is unavailable."],
                        "source_artifact_id": None,
                        "refresh_fingerprint": "f" * 64,
                    },
                    "portfolio_indicators": [
                        {
                            "key": "overlap",
                            "label": "Look-through overlap",
                            "detail": "Low overlap with the held book",
                            "effect": "positive",
                            "missing": False,
                        }
                    ],
                    "portfolio_role_labels": ["Diversifier"],
