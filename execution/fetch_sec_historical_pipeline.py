...
COMPANY_SCHEMAS = {
    "GOOGL": {
        ...
        "search_revenue": ["goog:GoogleSearchAndOtherMember", "Google Search & other - Google Services"]
    },
    "MELI": {
    ...
    "NOW": {
        ...
        "professional_services": ["now:ProfessionalServicesMember", "Professional services and other"]
    },
    "NU": {
