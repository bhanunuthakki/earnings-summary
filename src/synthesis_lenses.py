...
# ===========================================================================
# 10. mgmt_credibility_score — per-ticker mgmt track record from predictions
# ===========================================================================
...
def _ctx_mgmt_credibility(ticker: str | None, repo_root: Path) -> LensContext | None:
    ...
    return LensContext(
        ...
        cache_inputs=[ticker, _sha8(histo_block), _sha8(recent_block)],
        source_doc_ids=[],
        parent_artifact_ids=[],
    )
...
# ===========================================================================
# 11. llm_calibration — does the LLM's stated conviction match outcomes?
# ===========================================================================
...
# ===========================================================================
# 12. customer_concentration_risk — portfolio-wide single-customer exposure
# ===========================================================================
...
LENSES: dict[str, Lens] = {
    ...
    "customer_concentration_risk": Lens(
