...
_MASTER_GEOMETRY_DIGESTS: Mapping[str, str] = MappingProxyType(
    {
        ...
        "pipeline/work_os_styles.py": "2512faa8be4e5455d3ad1b86a9912e938b1fcf584c970efebef78b91da7fbf57",  # pragma: allowlist secret
...
_DYNAMIC_VISUAL_DIGESTS: Mapping[str, str] = MappingProxyType(
    {
        ...
        "pipeline/work_os_shell.py": "086410f0dc20d78e14f90549f470d3a8bd9deb33b13046b51577014a95b03236",  # pragma: allowlist secret
