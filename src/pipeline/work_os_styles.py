...
.work-os-evaluation-list { display:grid; gap:var(--sp-2); }
.work-os-evaluation-thread { display:grid; grid-template-columns:minmax(0, 1fr) auto; align-items:center; gap:var(--sp-3); }
