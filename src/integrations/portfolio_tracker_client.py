...
_PERFORMANCE_REASON_CODES = frozenset(
    {
        ...
        "partial_account_valuation_start_date",
        "partial_account_valuation_end_date",
        "account_valuation_integrity_invalid",
        ...
        "account_valuation_index_exclusion_unsupported",
        "provider_valuation_as_of_unasserted",
        "performance_window_too_short",
        ...
        "broker_archive_coverage_not_complete",
        "external_flow_provenance_current_decision_missing",
        "external_flow_provenance_current_decision_conflict",
        "external_flow_provenance_current_decision_unapproved",
        "external_flow_provenance_current_decision_unresolved",
        "external_flow_provenance_current_decision_provisional",
        "external_flow_provenance_target_transaction_missing",
        "external_flow_provenance_target_transaction_account_mismatch",
        "external_flow_provenance_target_transaction_economics_mismatch",
        "external_flow_provenance_transaction_target_conflict",
        "external_flow_provenance_decision_payload_digest_mismatch",
        "external_flow_provenance_source_event_set_digest_mismatch",
        "external_flow_provenance_effective_date_basis_mismatch",
