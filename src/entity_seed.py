...
PORTFOLIO_HOLDINGS: dict[str, CompanySeed] = {
    "AMZN": CompanySeed(
        ...
        segments=[
            ...
            SegmentSeed(
                canonical_name="Physical Stores", aliases=["Brick-and-Mortar", "Whole Foods"]
            ),
        ],
    ...
    "BN": CompanySeed(
        ...
        segments=[
            ...
            SegmentSeed(
                canonical_name="Private Equity", aliases=["BBU", "Brookfield Business Partners"]
            ),
...
WATCHLIST_BIZ_MODELS: dict[str, dict[str, str]] = {
    ...
    "CDNS": {"name": "Cadence Design Systems, Inc.", "display": "Cadence", "sector": "Technology"},
    ...
    "HASI": {
        "name": "HA Sustainable Infrastructure Capital",
        "display": "HASI",
        "sector": "Financials",
    },
