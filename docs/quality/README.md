...
- 1,339 executable modules and 495,092 non-comment lines.
...
- The function-lifecycle receipt validates as `PASS` for 33,900 symbols:
  11,766 protected, 15,737 referenced, 6,382 unknown, and 15 conservative
