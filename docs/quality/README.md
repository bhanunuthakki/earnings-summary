...
- 1,339 executable modules and 495,074 non-comment lines.
...
- The function-lifecycle receipt validates as `PASS` for 33,897 symbols:
  11,764 protected, 15,736 referenced, 6,382 unknown, and 15 conservative
