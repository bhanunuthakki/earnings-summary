...
REM Provider order belongs to the shared fleet policy. Scheduled jobs fail closed
REM to that policy's selected primary unless the canonical fallback control was
REM explicitly supplied by the operator.
set "LLM_EXPLICIT_MODEL_POLICY=primary-tier"
if not defined LLM_SUBSCRIPTION_FALLBACK_DISABLED set "LLM_SUBSCRIPTION_FALLBACK_DISABLED=1"
set "LLM_FALLBACK_DISABLED=%LLM_SUBSCRIPTION_FALLBACK_DISABLED%"
set "OPENAI_API_KEY="
set "CODEX_API_KEY="
