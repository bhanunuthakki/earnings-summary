...
| Task name | Cadence | XML | Wrapper | What it does |
|---|---|---|---|---|
| `earnings-summary\weekly_p2_lens_refresh` | Weekly, Sunday 02:00 | `weekly_p2_lens_refresh.task.xml` | `run_weekly_p2_lens_refresh.bat` | Regenerates the narrow P2 lens set (`five_min_reread`, `thesis_drift_qoq`) for active watchlist/evaluation names at a 7-day due age. It does not build watchlist DCFs or full briefs. |
